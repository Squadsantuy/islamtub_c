...
function renderPrayers(t) {
  const list = [{id:'Fajr', n:'Subuh'}, {id:'Dhuhr', n:'Dzuhur'}, {id:'Asr', n:'Ashar'}, {id:'Maghrib', n:'Maghrib'}, {id:'Isha', n:'Isya'}];
...
function startClock(t) {
  const pMap = [{k:'Fajr', n:'Subuh'}, {k:'Dhuhr', n:'Dzuhur'}, {k:'Asr', n:'Ashar'}, {k:'Maghrib', n:'Maghrib'}, {k:'Isha', n:'Isya'}];
  setInterval(() => {
    const now = new Date();
...
// Menjalankan widget saat DOM siap
